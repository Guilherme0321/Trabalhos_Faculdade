...
class No{
    ...
    public No(Jogador element){
        this.element = element;
        this.key = element.getAltura();
    }
...
public class RHashTable {
    ...
    public void inserir(Jogador element){
        int index = hash(element.getAltura());
        if(players[index] == null){
            players[index] = new No(element);
        }else{
            index = rehash(element.getAltura());
            if(players[index] == null){
                players[index] = new No(element);
            }
        }
    ...
    public boolean search(Jogador element){
        int index = hash(element.getAltura());
        if(players[index] == null){
            return false;
        }else if(players[index].getElement().getNome() == element.getNome()){
            return true;
        }else{
            index = rehash(element.getAltura());
            if(players[index] == null){
    ...
    public static void main(String[] args) {
        ...
        while(!entrada.equals("FIM")){
            ...
            Jogador temp = Jogador.search(play, entrada);
            boolean isIN = hash.search(temp);
            if(isIN){
